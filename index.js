document.write("Dinara Yelesh, CS-2123" + '<p>');
...
document.write(Math.ceil((univer.getTime()-today.getTime())/(one_day))+  " days until the freedom!" + '<p>');


function multiplyByNumber()
{
        num1 = document.getElementById("1tNumber").value;
